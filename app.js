...
import introMineTitleRaw from './views/introMineTitle.html';
...
const introMineTitle = template(introMineTitleRaw, {teddyImg});
...
async function startAnimation() {
	try {
		...
		await fastWrite(introEl, introMineTitle);
...
async function surprisinglyShortAttentionSpan() {
	...
	introEl.innerHTML = '';
	fastWrite(introEl, introMineTitle);
